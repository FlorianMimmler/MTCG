...
CREATE TABLE IF NOT EXISTS public."TradeRequest" (
    ...
    CONSTRAINT traderequest_userid_fk FOREIGN KEY ("requestUserID") REFERENCES public."User"(id) ON DELETE CASCADE,
...
DROP TABLE IF EXISTS public."ShopItem";
...
CREATE TABLE public."ShopItem" (
	...
	CONSTRAINT shopitem_pk PRIMARY KEY (id)
);

INSERT INTO public."ShopItem" (id, name, description, "type", price) VALUES(1, 'Mystery Pack', 'Can hold Coins, a Card or nothing. Good Luck!', 'mysterypack', 10);

ALTER TABLE IF EXISTS public."ShopItem"
    OWNER to admin;
