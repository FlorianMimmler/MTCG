...
namespace MTCG.BusinessLayer.Model.Shop
{
    internal class MysteryPack : ShopItem
    {
        ...
        private readonly int CardPercentage = 15;
        private readonly int CoinsPercentage = 60;
        private readonly int NothingPercentage = 25;
        ...
        public MysteryResult GetMystery()
        {
            ...
            {
                return new MysteryResult(true, "coins", coins: RandomGen.Next(3, 15));
            }
            else
            {
